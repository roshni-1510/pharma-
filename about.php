...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover inner-page" style="background-image: url('images/header7.jpg');">
      <div class="container">
        <div class="row">
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-5">
            ...
            <p>PharmaPlus.com, is brought to you by the Pharmaplus Company – one of India’s
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-5 mr-auto">
            ...
            <p class="text-black">Pharmaplus.com continues a legacy of 100 years of success in the
