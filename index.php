...
<body>
  ...
  <div class="site-wrap">
    ...
    ?>
    <div class="site-blocks-cover" style="background-image: url('images/header7.jpg');">
      <div class="container">
        <div class="row">
          <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
            <div class="site-block-cover-content text-center">
              <h2 style="color:black;">Effective Medicine, New Medicine Everyday</h2>
              <h1 style="color: white ;">Welcome To <span style="color:white;">pharma<sup>+</sup></span></h1>
              
              <p>
                <a href="store.php" class="btn btn-primary px-5 py-3" style="color:aliceblue;">Shop Now</a>
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="nonloop-block-3 no-direction owl-carousel">
              ...
              <div class="testimony">
                <blockquote>
                  ...
                  <p>&ldquo;PharmaPlus service during COVID 19 is magnificent. It gives good discounts than
              ...
              <div class="testimony">
                <blockquote>
                  ...
                  <p>&ldquo;As an NRI for me personally PharmaPlus offers a great relief in getting medicines
              ...
              <div class="testimony">
                <blockquote>
                  ...
                  <p>&ldquo;Now I became customer of PharmaPlus.com. Every time I ordering the medicine on pharma.com
              ...
              <div class="testimony">
                <blockquote>
                  ...
                  <p>&ldquo;I would like to thanks PharmaPlus for their brilliant Customer Service. I ordered
                    medicines from Pharma and they delivered my medicines within 3 days. Keep it up the
                    good work. PharmaPlus is the best medicine app. I recommend everyone to use Pharma
                    Website.&rdquo;</p>
                </blockquote>
